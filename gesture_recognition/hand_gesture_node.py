...
# sys.path.append("/home/lourencorcc/tese/dev_ws/src/gesture_recognition/gesture_recognition/utils")
# sys.path.append("/home/lourencorcc/tese/dev_ws/src/gesture_recognition/gesture_recognition/model")

# from gesture_recognition.utils.cvfpscalc import CvFpsCalc
...
class HandGestureRecognitionNode(Node):
    def __init__(self):
        ...
        # Load the keypoint and point history classifiers
        self.keypoint_classifier = KeyPointClassifier()
        self.point_history_classifier = PointHistoryClassifier()

        # Load labels
        with open('/home/lourencorcc/tese/dev_ws/src/gesture_recognition/gesture_recognition/model/keypoint_classifier/keypoint_classifier_label.csv', encoding='utf-8-sig') as f:
            self.keypoint_classifier_labels = [row[0] for row in csv.reader(f)]
        with open('/home/lourencorcc/tese/dev_ws/src/gesture_recognition/gesture_recognition/model/point_history_classifier/point_history_classifier_label.csv', encoding='utf-8-sig') as f:
        ...
        self.mode = 0
        self.publisher = self.create_publisher(Int32, 'hand_topic', 10)
    ...
    def image_callback(self, msg):
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                logging_csv(number, self.mode, pre_processed_landmark_list, pre_processed_point_history_list)
                ...
                # Publish information on the detected Hand gesture
                print(f"Publishing Hand sign ID: {hand_sign_id.item()} /// ", type(hand_sign_id.item()))
                classification_msg = Int32()
                classification_msg.data = hand_sign_id.item()
                self.publisher.publish(classification_msg)
